...
encounter choices. This typing system, also, guarantees that data is
send and received in the correct order and by the correct processes
(session fidelity), and that the communication is always one-to-one.
The \Kwd{CC0} programming language is secure in terms of both memory
